...
function generateCoverageReport(registryPath: string, testGlob: string): void {
...
const testGlob = process.argv[3] || 'tests/e2e/**/*.spec.ts';

if (fs.existsSync(registryPath)) {
  generateCoverageReport(registryPath, testGlob);
} else {
